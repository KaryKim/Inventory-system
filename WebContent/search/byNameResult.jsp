...
<jsp:include page="../head.jsp"></jsp:include>
	...
	<div id="content">
		<%
		Map<String,List> recordResult = (Map)request.getAttribute("data");
		List inResult = recordResult.get("in");
		List outResult = recordResult.get("out");
	%>

			<div id="ouStorage" class="storagestate">
				<h3>
					<span style="color: red">出</span>库情况
				</h3>
			...
			<div id="intorage" class="storagestate">
				<h3>
					<span style="color: red">入</span>库情况
				</h3>
				<table border="1" class="t1">
					<tr>
						<th>名称</th>
