...
<jsp:include page="../head.jsp"></jsp:include>
	...
	<div id="content">
		<div>
			<form action="queryByzhonglei.do" method="post">
			
					<div id="search">
						<label for="search"><h3>请输入需要搜索的种类名称</h3> </label> <input
							type="text" name="zl" placeholder="食品/服装/日用品/家具"> <input class="button" type="submit"
							value="搜索">
					</div>
