...
<style type="text/css">
body {
	display: block; /* div 默认 block 级别, inline 会使 尺寸类属性失效 */
	min-width: 850px;
}
...
window.onload=function(){
	...
	document.getElementById("dateShow").value=localDate;
};
</script>
</head>
<body>
	...
	<div id="content">
		<h3>
			请输入<span style="color: red;">出</span>库商品数据
		</h3>
		<div>
			<form action="outStorage.do" method="post">
				...
				<table border="1" class="t1" style="margin: 5px auto;">
					...
					<tr>
						<td height="62">日期：</td>
						<td><input type="date" name="date" required="required"  id="dateShow"/></td>
					</tr>
					<tr>
						<td height="62">时间：</td>
					...
					<tr>
						<td height="62">出库单位：</td>
						<td><input type="text" name="tounit"></td>
					</tr>
					<tr>
						<td height="62">种类：</td>
