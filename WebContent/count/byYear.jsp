...
<jsp:include page="../head.jsp"></jsp:include>
	...
	<div id="content" >
			...
			<form action="countByYear.do" method="post">
			
					<div id="search">
						<label for="search"><h3>请选择需要统计的年份</h3> </label> <input
							type="text" class="Wdate" onFocus="WdatePicker({lang:'zh-cn',dateFmt:'yyyy年'})" placeholder="选择年份" name="year" required="required"/>
