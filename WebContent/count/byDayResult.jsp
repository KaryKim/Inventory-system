	...
	<div id="content">
		...
		%>
			...
			<div id="ouStorage" class="storagestate">
				<h3>
					该日<span style="color: red">出</span>库总量<span style="color: red"><%=outStorageNumber%></span>件
				</h3>
			...
			<div id="intorage" class="storagestate">
				<h3>
					该日<span style="color: red">入</span>库总量<span style="color: red"><%=inStorageNumber%></span>件
				</h3>
				<table border="1" class="t1">
					<tr>
						<th>名称</th>
