...
.button:focus, input[type=date]:focus, input[type=password]:focus {
	outline: none;
	border-color: #51a7e8;
...
<jsp:include page="../head.jsp"></jsp:include>
	...
	<div id="content">
		<div>
			<form action="countByDay.do" method="post">
			
					<div id="search">
						<label for="search"><h3>请选择需要统计的日期</h3> </label> <input
							type="date" name="date" required="required"> <input class="button" type="submit"
							value="确定">
					</div>
